    ...
    public static ResponseEntity<Object> exceptionHandler(ResponseEntity<Object> responseEntity) {
        try {
            return responseEntity; /*
                                    ...
                                    * ResponseModel(HttpStatus.BAD_REQUEST,
                                    ...
                                    * } catch (SpecificException e) {
                                    * return ResponseEntity.status(HttpStatus.TOO_MANY_REQUESTS).body(new
                                    * ResponseModel(HttpStatus.
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new ResponseModel(
                    HttpStatus.INTERNAL_SERVER_ERROR, HttpStatus.INTERNAL_SERVER_ERROR.value(), e.getMessage()));
        }
    }
}
